!(function ($) {
    ...
    function crossSlider($Scope, $){
        ...
        class Slide {
            constructor(el, title) {
                ...
                this.DOM.img = this.DOM.imgWrap.querySelector('.cross-img');
            }
            move(direction, val) {
            ...
            setCenter() {
                ...
                gsap.set([this.DOM.el, this.DOM.title], {opacity: 1});
            }
            setRight() {
            ...
            reset() {
                gsap.set([this.DOM.el, this.DOM.imgWrap, this.DOM.number, this.DOM.subtitle, this.DOM.title], {transform: 'none'});
                gsap.set([this.DOM.el, this.DOM.title], {opacity: 0});
            ...
            animateElementsOut(contentItem) {
                return new Promise((resolve, reject) => {
                    ...
                    if ( this.isCenter ) {
                        ...
                        this.elemsTimeline.to(contentItemTitle, {
                            duration: 0.8,
                            ease: Expo.easeOut,
            ...
            animateElementsIn(contentItem) {
                return new Promise((resolve, reject) => {
                    ...
                    this.elemsTimeline.to(this.DOM.subtitle, {
                        duration: 0.8,
                        y: 0,
                        opacity: 1,
                        ease: Quart.easeOut
        ...
        class Slideshow {
            constructor(el) {
                ...
                const render = () => {
                    ...
                    for (let i = 0; i <= this.slidesTotal - 1; ++i) {
                        gsap.set(this.slides[i].DOM.img, {x: mouseMoveVals.translation});
                        gsap.set(this.DOM.titlesInner, {x: -4*mouseMoveVals.translation});
                    }
            ...
            initEvents() {
                ...
                this.mouseleaveCenterFn = () => {
                    ...
                    gsap.timeline().to(this.centerSlide.DOM.imgWrap, {
                        duration: 0.7,
                        ease: Expo.easeOut,
                        scale: 1
                    })
            ...
            navigate(direction) {
                ...
                gsap.set(this.upcomingSlide.DOM.el, {x: direction === 'right' ? this.gap*2 : -1*this.gap*2, opacity: 1});
                gsap.set(this.upcomingTitle, {x: direction === 'right' ? this.gap*2 : -1*this.gap*2, opacity: 1});
        ...
        document.body.classList.add('crossslider-cursor');
        // Preload all the images in the page
        imagesLoaded(document.querySelectorAll('.cross-img'), {background: true}, () => document.body.classList.remove('loading'));

        $( '.cross-slider .grid__item, .cross-slider .img-wrap' ).hover(
          function() {
            $( '.awam-cursor' ).addClass( 'hide' );
          }, function() {
            $( '.awam-cursor' ).removeClass( 'hide' );
          }
        );
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/wavo-crossroads-slideshow.default', crossSlider);
    });
