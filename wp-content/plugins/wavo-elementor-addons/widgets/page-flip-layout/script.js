!(function ($) {
    ...
    function flipPageLayoutSlider($Scope, $){
        ...
        class Slideshow {
            constructor(el) {
                ...
                // The page turning animations.
                this.pageturn = new PageTurn(this.DOM.el.querySelector('.flip-revealer'), this.slidesTotal);
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/wavo-page-flip-layout.default', flipPageLayoutSlider);
    });
