!(function ($) {
    ...
    /* wavoBlogSlider */
    function wavoBlogSlider2( $scope, $ ) {
        $scope.find( '.blog--slider-wrapper' ).each(function () {
            ...
            // initialize
            const mySwiper = new Swiper(mySlider, options);
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/wavo-blog-slider2.default', wavoBlogSlider2);
    });
